execute as @a if score @s dk_active matches 1 run title @a actionbar ["§aGlobal §aDay: ",{"score":{"name": "Dia","objective": "Info"},"color": "yellow"}," §aHour: ",{"score":{"name": "hour","objective": "Info"},"color": "yellow"}," §aMin: ",{"score":{"name": "min","objective": "Info"},"color": "yellow"}," §aSeg: ",{"score":{"name": "seg","objective": "Info"},"color": "yellow"}]
